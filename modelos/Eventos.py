...
class EventoBase(SQLModel):
    ...
    jugador_id: int = Field(foreign_key="jugador.id_jugador", nullable=False, description="ID del jugador asociado")
    jugador_asociado_id: Optional[int] = Field(default=None, foreign_key="jugador.id_jugador", description="ID del jugador asociado (para sustituciones u otros eventos)")
